...
@if exist "%APP_PATH%" (
    ...
    call git clone -b 3.0 git://github.com/randall-vx/spf13-vim.git "%APP_PATH%"
)
...
@if not exist "%HOME%/.vim/bundle/vundle" call git clone https://github.com/randall-vx/Vundle.vim.git "%HOME%/.vim/bundle/vundle"
